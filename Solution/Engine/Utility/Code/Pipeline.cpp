...
void CPipeline::MakeViewMatrix(_matrix * pMatrix, const _vec3 * pEye, const _vec3 * pAt, const _vec3 * pUp)
{
...
void CPipeline::MakeProjMatrix(_matrix * pMatrix, const _float & fFov, const _float & fAspect, const _float & fNear, const _float & fFar)
{
	D3DXMatrixIdentity(pMatrix);
